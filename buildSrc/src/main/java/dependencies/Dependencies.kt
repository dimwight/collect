...
object Dependencies {
    ...
    const val androidx_viewpager2= "androidx.viewpager2:viewpager2:1.1.0"
    ...
    const val javarosa_online = "org.getodk:javarosa:5.0.0"
    ...
    const val kotlin_stdlib = "org.jetbrains.kotlin:kotlin-stdlib:2.0.0"
    const val gson = "com.google.code.gson:gson:2.11.0"
    const val firebase_analytics = "com.google.firebase:firebase-analytics:22.0.2"
    const val firebase_crashlytics = "com.google.firebase:firebase-crashlytics:19.0.2"
    const val leakcanary = "com.squareup.leakcanary:leakcanary-android:2.14"
    const val timber = "com.jakewharton.timber:timber:5.0.1"
    const val slf4j_api = "org.slf4j:slf4j-api:2.0.13"
    const val slf4j_timber = "com.arcao:slf4j-timber:3.1@aar"
    const val emoji_java = "com.vdurmont:emoji-java:5.1.1"
    const val json_schema_validator = "com.networknt:json-schema-validator:1.4.3"
    ...
    const val mockito_android = "org.mockito:mockito-android:5.12.0"
    ...
    const val androidx_test_rules = "androidx.test:rules:1.6.1"

...
public class ISODatePickerDialogTest {
    ...
    public void setup() {
        ...
        datePickerDetails = DialogFragmentHelpers.setUpDatePickerDetails(DatePickerDetails.DatePickerType.GREGORIAN);
    ...
    public void dialogShouldShowCorrectDate() {
        ...
        DialogFragmentHelpers.assertDialogShowsCorrectDate(2020, 5, 12, "May 12, 2020");
    }
    ...
    public void dialogShouldShowCorrectDate_forYearMode() {
        ...
        DialogFragmentHelpers.assertDialogShowsCorrectDateForYearMode(2019, "2019");
    }
    ...
    public void dialogShouldShowCorrectDate_forMonthMode() {
        ...
        DialogFragmentHelpers.assertDialogShowsCorrectDateForMonthMode(2020, 4, "Apr 2020");
    }
    ...
    public void settingDateInDatePicker_changesDateShownInTextView() {
        ...
        DialogFragmentHelpers.assertDialogTextViewUpdatesDate("May 12, 2020", 2020, 5, 12);
    }

    @Test //
    public void whenScreenIsRotated_dialogShouldRetainDateInDatePickerAndTextView() {
        DialogFragmentHelpers.assertDialogRetainsDateOnScreenRotation(dialogFragment, "May 12, 2020", 2020, 5, 12);
    }
    ...
    public void clickingOk_updatesDateInActivity() {
        ...
        DialogFragmentHelpers.assertDateUpdateInActivity(activity, 2020, 5, 12);
    }

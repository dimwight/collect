...
public class IslamicDatePickerDialog extends CustomDatePickerDialog {
    ...
    private void setUpDatePicker() {
        ...
        int month = islamicDate.getMonthOfYear();
        System.out.println("6330I: setUpDatePicker " + month);
        setUpMonthPicker(month, monthsArray);
    ...
    private LocalDateTime getCurrentIslamicDate() {
        System.out.println("6330I: getCurrentIslamicDate");
